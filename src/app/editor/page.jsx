  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center p-4 space-y-12">
      <div className="controls space-y-3">
        ...
        <Input type="number" placeholder="cols" value={cols} onChange={(e) => { setCols(Number(e.target.value)) }} />
        <Input type="number" placeholder="line" value={line} onChange={(e) => { setLine(Number(e.target.value)) }} />
        <Input type="color" value={color} onChange={(e)=>{ setColor(e.target.value) }}/>
        <Button onClick={() => { controls() }}>apply changes</Button>
